...
{question:"Jika A subset dari B, dan B subset dari C, maka A subset dari ...",options: ["C (transitivitas subset)","Hanya B","Tidak ada","A saja","Semua himpunan"],answer:0,hint:"Subset transitif: A$\\subseteq$BB dan B$\\subseteq$CC maka A$\\subseteq$CC.",explanation:"Transitivitas: A$\\subseteq$BB, B$\\subseteq$CC => A$\\subseteq$CC.\nSetiap elemen A ada di B, setiap elemen B ada di C, maka setiap elemen A ada di C.\nJawaban: A."},
]);
...
{question:"Deret Taylor dari e^x di sekitar x=0 = ...",options: ["Su$m_{n=0}$^{inf} x^n/n! = 1+x+$x^2$/2+$x^3$/6+...","Sum x^n","Sum 1/n","ln(x)","1/(1-x)"],answer:0,hint:"e^x = 1 + x + x^2/2! + x^3/3! + ...",explanation:"e^x = Su$m_{n=0}$^{inf} x^n/n!.\n= 1 + x + $x^2$/2 + $x^3$/6 + $x^4$/24 + ...\nKonvergen untuk semua x real.\nJawaban: A."},
]);
