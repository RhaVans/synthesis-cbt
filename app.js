...
const REGEX_MATH_INDICATOR = /\$|\\[a-zA-Z]|[a-zA-Z0-9]\^[{0-9\-]|(^|[^a-zA-Z0-9_])[a-zA-Z0-9]+_(?:\{|[0-9]|[a-zA-Z](?![a-zA-Z0-9_]))/;
const REGEX_LATEX_TOKEN = /\$[^\$]+\$|\\[a-zA-Z]+(?:_(?:\{[^{}]*\}|[a-zA-Z0-9])|\^(?:\{[^{}]*\}|[a-zA-Z0-9])|\{[^{}]*\}|\([^)]*\))*|(^|[^a-zA-Z0-9_])([a-zA-Z0-9]+\^(?:\{[^{}]*\}|[\-0-9a-zA-Z]+))|(^|[^a-zA-Z0-9_])([a-zA-Z0-9]+_(?:\{[^{}]*\}|[0-9]+[a-zA-Z0-9]*|[a-zA-Z](?![a-zA-Z0-9_]))(?![a-zA-Z0-9_]))/g;
const REGEX_BOLD = /\*\*(.*?)\*\*/g;
