...
{question:"Jika gradient garis 3x+6y=12 adalah ...",options:["-1/2","3","6","1/2","2"],answer:0,hint:"6y=-3x+12 => y=-x/2+2. m=-1/2.",explanation:"y = -x/2+2. m=-1/2.\nJawaban: A."},
...
{question:"Jika a/b = 3/5, berapa (a+b)/b?",options:["8/5","3/5","5/3","8/3","15"],answer:0,hint:"(a+b)/b = a/b + b/b = 3/5 + 1 = 8/5.",explanation:"(a+b)/b = a/b+1 = 3/5+5/5 = 8/5.\nJawaban: A."},
...
{question:"Konversi 75% ke pecahan paling sederhana = ...",options:["3/4","75/100","15/20","7/5","4/3"],answer:0,hint:"75/100 = 3/4 (bagi 25).",explanation:"75% = 75/100 = 3/4.\nJawaban: A."},
...
{question:"Tentukan x: 4^x = 2. x = ...",options:["1/2","2","4","0","1"],answer:0,hint:"4^(1/2) = sqrt(4) = 2. x=1/2.",explanation:"4^(1/2) = sqrt(4) = 2. x = 1/2.\nJawaban: A."},
...
{question:"Konversi 0.6 berulang (0.666...) ke pecahan = ...",options:["2/3","3/5","6/10","3/6","6/9"],answer:0,hint:"x=0.666... 10x=6.666... 9x=6. x=6/9=2/3.",explanation:"x = 0.6666...\n10x = 6.666...\n9x = 6 => x = 2/3.\nJawaban: A."},
...
{question:"Jika ruang sampel S = {1,2,3,4,5,6} (dadu), peluang mendapat bilangan genap = ...",options:["1/2","1/3","1/6","2/3","3"],answer:0,hint:"Genap: {2,4,6} = 3 dari 6 = 1/2.",explanation:"P(genap) = 3/6 = 1/2.\nJawaban: A."},
