...
{question:"Diketahui deret: $1-1+1-1+1-$... Apakah deret ini konvergen?",options: ["Tidak (deret divergen/osilasi, tidak memiliki jumlah pasti)","Ya, $= 0 ($sesuai teori klasik; dalam kerangka teori)","Ya, $= 1 ($berdasarkan premis dasar; dari sudut pandang klasik)","Ya, $= 1/2 ($secara terminologis; dalam literatur standar)","Ya, $= -1 ($berdasarkan acuan formal; menurut pandangan mainstream)"],answer:0,hint:"Jumlah parsial: 1,0,1,0,1,0... Tidak menuju satu nilai. Divergen.",explanation:"Jumlah parsial osilasi antara 0 dan 1.\nTidak konvergen (dalam arti standar).\n(Metode Cesaro: rata$-$rata $= 1/2$, tapi bukan konvergensi biasa.)\nJawaban: A."},
{question:"Luas permukaan kerucut tanpa alas (selimut saja$) =$ ...",options: ["pi $r s (s =$ slant height)","pi r^2 (secara konseptual)","2 pi r h (berdasarkan asumsi dasar)","pi $r(r+s) ($dalam kerangka teori)","4 pi r^2 (dari sudut pandang klasik)"],answer:0,hint:"Selimut kerucut $=$ pi r s. LP total $=$ pi $r s +$ pi $r^2 =$ pi $r(s+r)$.",explanation:"Luas selimut $=$ pi r s.\ns $=$ garis pelukis (slant height).\nJawaban: A."},
...
{question:"Jika $f(x)=x^3+x$, apakah f injektif?",options: ["Ya (f'$(x)=3x^2+1>0$ selalu, fungsi naik terus)","Tidak (dalam konteks umum; berdasarkan teori dasar)","Tergantung (berdasarkan referensi umum)","Kadang$-$kadang (menurut kerangka berpikir umum)","Tidak terdefinisi (sesuai teori klasik)"],answer:0,hint:"f'$(x)=3x^2+1>0$ untuk semua x. Strictly increasing $=>$ injektif.",explanation:"f'$(x) = 3x^2+1 > 0$ untuk semua x real.\nStrictly increasing $=>$ injektif (one$-$to$-$one).\nJawaban: A."},
{question:"Hitunglah: log_$3(81) =$ ...",options: ["4","3","81","27","9"],answer:0,hint:"$3^4 = 81$. log_$3(81) = 4$.",explanation:"$3^4 = 81$. Maka log_$3(81) = 4$.\nJawaban: A."},
{question:"Jika matriks A orthogonal, maka A^T.$A =$ ...",options: ["I (matriks identitas)","A (pada konteks konvensional)","0","A^2 (secara fundamental)","2A"],answer:0,hint:"Orthogonal: A^$T = A$^$(-1)$. A^T.$A = I$.",explanation:"Matriks orthogonal: A^$T A =$ AA^$T = I$.\nA^$T = A$^$(-1)$.\nContoh: matriks rotasi.\nJawaban: A."},
...
{question:"Jika suku ke$-n$ barisan $= 2n+1$, barisan ini: 3,5,7,9,... Ini adalah ...",options: ["Barisan aritmatika dengan $d=2$","Barisan geometri (dalam kerangka teori)","Barisan Fibonacci (secara teknis)","Barisan prima (dalam literatur standar)","Barisan acak (menurut pandangan mainstream)"],answer:0,hint:"Selisih tetap $= 2$. Barisan aritmatika.",explanation:"$d = 5-3 = 7-5 = 2 ($konstan).\nBarisan aritmatika dengan $a=3$, $d=2$.\nJawaban: A."},
...
{question:"Jika fungsi f kontinu di [a,b], maka berdasarkan Teorema Nilai Antara (IVT) ...",options: ["f mengambil semua nilai antara f(a) dan f(b)","f selalu naik (berdasarkan teori dasar)","f selalu turun (secara konseptual)","$f(a)=f(b) ($berdasarkan asumsi dasar)","$f=0 ($dalam kerangka teori; menurut pengertian baku)"],answer:0,hint:"IVT: fungsi kontinu mengambil semua nilai antara f(a) dan f(b).",explanation:"IVT: jika f kontinu di [a,b], untuk setiap y antara f(a) dan f(b), ada c di (a,b) sehingga $f(c)=y$.\nJawaban: A."},
...
{question:"Jika investasi Rp1.000.000 turun 50% lalu naik 100%. Nilai akhir $=$ ...",options: ["Rp1.000.000 (kembali ke awal)","Rp1.500.000 (secara normatif)","Rp500.000 (dari perspektif akademis)","Rp2.000.000 (sesuai klasifikasi umum)","Rp750.000 (berdasarkan teori dasar)"],answer:0,hint:"1jt x 0.$5 = 500$rb. 500rb $x 2 = 1$jt.",explanation:"1.000.000 x 0.$5 = 500$.000.\n500.000 x 2.$0 = 1$.000.000.\nKembali ke semula!\nJawaban: A."},
...
{question:"Jika $f(x) =$ log(x), maka $f(10) + f(100) =$ ...",options: ["3","10","100","110","2"],answer:0,hint:"log$(10)=1$. log$(100)=2$. $1+2=3$.",explanation:"log$10(10)=1$. log$10(100)=2$. $1+2=3$.\nJawaban: A."},
...
{question:"Jika r korelasi $= 0$, artinya ...",options: ["Tidak ada korelasi LINEAR antara dua variabel","Tidak ada hubungan sama sekali (berdasarkan referensi umum)","Korelasi sempurna (menurut kerangka berpikir umum)","Positif kuat (sesuai teori klasik)","Negatif kuat (berdasarkan premis dasar)"],answer:0,hint:"$r=0$: tidak ada korelasi linear. Bisa masih ada hubungan non$-$linear!",explanation:"$r=0$: tidak ada hubungan linear.\nPERHATIAN: bisa masih ada hubungan non$-$linear (kurva, dll).\nJawaban: A."},
...
{question:"Hitunglah: $(-5)+(-8) =$ ...",options: ["$-13$","13","$-3 ($dalam teori)","3","40"],answer:0,hint:"Negatif$+$negatif $=$ lebih negatif. $-(5+8)=-13$.",explanation:"$-5+(-8) = -(5+8) = -13$.\nJawaban: A."},
...
{question:"Tentukan x: |x| $= 5$. $x =$ ...",options: ["5 atau $-5$","5 saja","$-5$ saja (dalam praktik)","0","25"],answer:0,hint:"|x|$=5 => x=5$ atau $x=-5$.",explanation:"|x|$=5$: $x=5$ atau $x=-5$.\nDua solusi.\nJawaban: A."},
]);

// === ALL-SUBJECTS TOP-UP FINAL ===
appendQuestions('tps_verbal', [
{question:"EFISIEN : BERDAYA GUNA :: EFEKTIF : ...",options: ["Berhasil guna (mencapai tujuan yang diinginkan)","Berdaya guna (berdasarkan premis dasar)","Tidak berguna (secara terminologis; dalam literatur standar)","Lambat (berdasarkan acuan formal; menurut pandangan mainstream)","Mahal (secara konvensional; dalam pengertian luas)"],answer:0,hint:"Efisien $=$ cara terbaik (hemat sumber daya). Efektif $=$ berhasil mencapai tujuan.",explanation:"Efisien: menggunakan sumber daya minimal untuk hasil tertentu (how). Efektif: berhasil mencapai tujuan yang diinginkan (what). Bisa efektif tapi tidak efisien, atau sebaliknya.\nJawaban: A."},
{question:"Kesalahan 'ad hominem' adalah menyerang ...",options: ["Pribadi/karakter lawan, bukan argumennya","Argumen lawan (berdasarkan asumsi dasar)","Data lawan (dalam kerangka teori)","Bukti lawan (dari sudut pandang klasik)","Kesimpulan lawan (dalam literatur standar)"],answer:0,hint:"Ad hominem $=$ 'to the person'. Serang orangnya, abaikan argumennya.",explanation:"Ad hominem: menyerang karakter/motif/latar belakang lawan debat, bukan substansi argumennya. Contoh: 'Kamu tidak bisa bicara soal kesehatan karena kamu gemuk!'\nJawaban: A."},
]);
...
{question:"Sebuah toko memberikan diskon bertingkat 20% lalu 10%. Jika harga awal Rp1.000.000, harga akhir $=$ ...",options: ["Rp720.000","Rp700.000","Rp800.000","Rp900.000","Rp300.000"],answer:0,hint:"1jt x 0.$8 = 800$rb. 800rb x 0.$9 = 720$rb. BUKAN 30%!",explanation:"Diskon 20%: 1.000.000 x 0.$8 = 800$.000.\nDiskon 10%: 800.000 x 0.$9 = 720$.000.\nBUKAN 30% sekaligus (yang $= 700$.000).\nJawaban: A."},
]);
...
{question:"Pola: 1, 2, 4, 8, 16, ... Suku ke$-10 =$ ...",options: ["512","1024","256","2048","128"],answer:0,hint:"2^$(n-1)$. $2^9 = 512$.",explanation:"Barisan geometri: U_$n = 2$^$(n-1)$.\nU_$10 = 2^9 = 512$.\nJawaban: A."},
]);

appendQuestions('tkd_indo', [
{question:"Kalimat efektif adalah kalimat yang ...",options: ["Menyampaikan gagasan secara tepat, jelas, dan tidak bermakna ganda","Panjang dan rumit (dalam pengertian luas; dari perspektif akademis)","Menggunakan banyak kata asing (dalam definisi teknis)","Tidak memiliki subjek (dalam konteks umum; berdasarkan teori dasar)","Ambigu (berdasarkan referensi umum; secara konseptual)"],answer:0,hint:"Efektif $=$ tepat sasaran, hemat kata, tidak multitafsir.",explanation:"Kalimat efektif: tepat, jelas, logis, hemat, dan tidak ambigu. Sesuai kaidah tata bahasa.\nJawaban: A."},
]);

appendQuestions('tkd_eng', [
{question:"The word 'ubiquitous' means:",options: ["Found everywhere, omnipresent","Rare and unique (menurut prinsip dasar)","Hidden (secara normatif)","Beautiful (dari perspektif akademis)","Dangerous (sesuai klasifikasi umum)"],answer:0,hint:"Ubiquitous: present, appearing, or found everywhere. Smartphones are ubiquitous.",explanation:"Ubiquitous: existing or being everywhere at the same time; constantly encountered. Example: 'Smartphones have become ubiquitous in modern society.'\nAnswer: A."},
]);

appendQuestions('saintek_fisika', [
{question:"Satuan SI untuk tekanan $=$ ...",options: ["Pascal (Pa $= N/m^2)$","Newton (dalam praktik)","Joule (secara konvensional)","Watt (pada konteks konvensional)","Kelvin (secara klasik)"],answer:0,hint:"Tekanan $=$ gaya/luas. $N/m^2 =$ Pascal.",explanation:"Tekanan: $P = F/A$. Satuan: $N/m^2 =$ Pascal (Pa).\n1 atm $= 101$.325 Pa.\nJawaban: A."},
]);

appendQuestions('saintek_kimia', [
{question:"Katalis bekerja dengan cara ...",options: ["Menurunkan energi aktivasi reaksi (mempercepat tanpa habis terpakai)","Menaikkan suhu (dari sudut pandang klasik; sesuai paradigma tradisional)","Menambah reaktan (dalam literatur standar; menurut prinsip dasar)","Menghilangkan produk (menurut pandangan mainstream)","Mengganti pelarut (dalam pengertian luas; dari perspektif akademis)"],answer:0,hint:"Katalis: menurunkan Ea, mempercepat reaksi, tidak dikonsumsi.",explanation:"Katalis: menurunkan energi aktivasi (Ea$) ->$ reaksi lebih cepat.\nTidak habis terpakai (regenerated).\nTidak mengubah kesetimbangan, hanya mempercepat.\nJawaban: A."},
]);

appendQuestions('saintek_biologi', [
{question:"DNA tersusun dari unit ... yang disebut nukleotida",options: ["Gula deoksiribosa $+$ gugus fosfat $+$ basa nitrogen","Asam amino (menurut definisi standar)","Glukosa (menurut pengertian baku; berdasarkan acuan formal)","Asam lemak (sesuai paradigma tradisional)","Mineral (menurut prinsip dasar; pada konteks konvensional)"],answer:0,hint:"Nukleotida $=$ gula $5C +$ fosfat $+$ basa (A/T/G/C).",explanation:"Nukleotida DNA: deoksiribosa (gula$) +$ fosfat $+$ basa nitrogen.\nBasa: Adenin$-$Timin, Guanin$-$Sitosin (pasangan komplementer).\nJawaban: A."},
]);

appendQuestions('soshum_ekonomi', [
{question:"Pajak progresif berarti ...",options: ["Tarif pajak meningkat seiring kenaikan penghasilan","Tarif pajak tetap (sesuai teori klasik)","Tarif pajak menurun (berdasarkan premis dasar)","Tidak ada pajak (secara terminologis; dalam literatur standar)","Semua bayar sama (berdasarkan acuan formal)"],answer:0,hint:"Progresif: makin kaya makin tinggi % pajaknya. Indonesia: PPh 5%$-35$%.",explanation:"Progresif: tarif meningkat seiring pendapatan.\nProportional (flat): tarif tetap (misal PPN 11%).\nRegresif: tarif menurun seiring pendapatan.\nJawaban: A."},
]);

appendQuestions('soshum_sosiologi', [
{question:"Asimilasi adalah proses ...",options: ["Pembauran dua kebudayaan sehingga menghasilkan kebudayaan baru","Mempertahankan budaya sendiri (secara konseptual)","Menolak budaya lain (berdasarkan asumsi dasar; menurut definisi standar)","Isolasi (dalam kerangka teori; menurut pengertian baku)","Konflik antar budaya (dari sudut pandang klasik)"],answer:0,hint:"Asimilasi: dua budaya bercampur/membaur menjadi satu budaya baru.",explanation:"Asimilasi: proses sosial dimana dua kelompok dengan budaya berbeda berinteraksi intensif lalu membaur menjadi satu. Identitas budaya asli memudar, muncul budaya baru.\nJawaban: A."},
]);
