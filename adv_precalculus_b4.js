...
// [Induksi Matematika]
{question:"Dalam pembuktian induksi matematika, langkah pertama adalah...",options:["Membuktikan pernyataan benar untuk $n = 1$ (basis)","Membuktikan untuk semua $n$","Mengasumsikan benar untuk $n = k$","Membuktikan untuk $n = k+1$","Membuktikan kontradiksi"],answer:0,hint:"Langkah basis menunjukkan kasus awal benar.",explanation:"Induksi matematika:\n1. **Basis**: buktikan $P(1)$ benar.\n2. **Langkah induktif**: asumsikan $P(k)$ benar, buktikan $P(k+1)$."},
...
{question:"Dalam langkah induktif, kita mengasumsikan $P(k)$ benar. Ini disebut...",options:["Hipotesis induksi","Basis induksi","Kontradiksi","Teorema","Aksioma"],answer:0,hint:"Asumsi bahwa pernyataan benar untuk $n=k$.",explanation:"Hipotesis induksi: asumsi bahwa $P(k)$ benar.\nKemudian kita harus menunjukkan $P(k+1)$ juga benar."},
...
{question:"Fungsi $f(x) = x^2 + x$ bersifat...",options:["Tidak genap dan tidak ganjil","Genap","Ganjil","Genap dan ganjil","Periodik"],answer:0,hint:"$f(-x) = x^2 - x \\ne f(x)$ dan $\\ne -f(x)$.",explanation:"$f(-x) = x^2 - x$.\n$f(x) = x^2 + x$.\n$f(-x) \\ne f(x)$ → bukan genap.\n$f(-x) \\ne -f(x) = -x^2-x$ → bukan ganjil."},
...
{question:"Fungsi $f: A \\to B$ disebut surjektif (onto) jika...",options:["Setiap $b \\in B$ memiliki preimage di $A$","$f$ satu-satu","$f$ invertible","$f$ kontinu","$f$ terdefinisi di semua $A$"],answer:0,hint:"Surjektif: setiap elemen kodomain tercakup.",explanation:"$f$ surjektif: $\\forall b \\in B, \\exists a \\in A$ sehingga $f(a) = b$.\nRange = kodomain."},
{question:"Fungsi bijektif adalah fungsi yang...",options:["Injektif dan surjektif","Injektif saja","Surjektif saja","Kontinu","Terdiferensialkan"],answer:0,hint:"Bijektif = satu-satu DAN onto.",explanation:"Bijektif = injektif + surjektif.\nFungsi bijektif memiliki invers."},
]);
